			...
			<section class="content">
				<div class="row">
					...
					<tr>
						...
						<td align="center" style="vertical-align:middle;"><a href="barang_peminjam"><?php echo $value->nama_barang;?></td>
						<td align="center" style="vertical-align:middle;"><a href="peminjam_peminjam"><?php echo $value->nama_peminjam;?></td>
